...
SECRET_KEY = "django-insecure-q=t26(+181f$1xg#@mjeh1kedg4_)7*bpn5t1dbc6dfd&u3se+"
...
# Authentication relatecd URL  
LOGIN_URL = 'login'  # Redirect here if not authenticated
LOGIN_REDIRECT_URL = 'list_employees'  # Redirect here after login
